...
public class AS2Receiver {
	...
	// The "receiver" web services URL. It should be "http://[ip]:[port]/corvus/httpd/as2/receiver".
	 ...
	 */
	public AS2Receiver(String receiverWSURLStr) throws MalformedURLException {
